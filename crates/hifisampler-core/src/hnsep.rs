...
use crate::burn::cascadednet::{CascadedNet, CascadedNetConfig};
...
impl HnsepModel {
    /// Load the HN-SEP model from a PyTorch checkpoint.
    pub fn load(
        ...
        info!("[hnsep] step 6: HN-SEP loaded {} tensors, done", result.applied.len());
